...
module('Integration | Component | s-notification-container', function(hooks) {
    setupRenderingTest(hooks);

    hooks.beforeEach(function(assert) {
      this.notificationService = this.owner.lookup('service:notifications');
      this.set('notificationService.messages', Ember.A());
    });

    test('it renders', async function(assert) {
      await render(hbs`{{s-notification-container}}`);
